...
from petercord import Config, Message, pool, petercord
...
PATH = "./petercord/xcache/ytsearch.json"
...
async def iytdl_inline(message: Message):
    ...
    if message.client.is_bot:
        ...
        x = await petercord.get_inline_bot_results(bot.username, f"ytdl {input_url}")
        await message.delete()
