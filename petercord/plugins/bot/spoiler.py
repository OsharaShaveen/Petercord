...
if petercord.has_bot:
        ...
        if os.path.exists(PATH):
            ...
            try:
                if mid:
                    ...
                    await message.reply("MAAF 🥺 , TIDAK BISA MENGAKSES HIKS:) !")
    ...
    @petercord.bot.on_callback_query(filters.regex(pattern=r"^getl([\S]+)$"))
    ...
    @petercord.bot.on_callback_query(filters.regex(pattern=r"^nobtnspoiler([\S]+)$"))
