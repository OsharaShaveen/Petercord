...
async def send_alive_message(message: Message) -> None:
    ...
    if client.is_bot:
        ...
        caption += (
            ...
            "    <code>|</code>    "
            "🎖  <a href='https://t.me/TEAMSquadUserbotSupport'><b>SUPPORT</b></a>"
        )
...
class Bot_Alive:
    ...
    def alive_info() -> str:
        alive_info_ = f"""
<a href="https://t.me/TEAMSquadUserbotSupport"><b>PETERCORD</a> is Up and Running.</b>
...
"""
    ...
    def alive_default_imgs() -> str:
        alive_imgs = [
            ...
            "https://telegra.ph/file/da184624f07b4f3b60041.jpg",
