...
petercord.__class__.__module__ = 'pyrogram.client'
...
@petercord.on_cmd("joinvc", about={
    ...
    'examples': [
        "{tr}joinvc -as=@TeamSquadUserbotSupport -at=@Aktifkannbot - Join VC of @Aktifkannbot as @TeamSquadUserbotSupport.",
...
@petercord.on_cmd("forceplay", about={
...
@petercord.on_cmd("current", about={
