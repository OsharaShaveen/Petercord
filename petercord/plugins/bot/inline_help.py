...
_COMMANDS = {
    ...
    "repo": {
        "help_txt": "**Your PETERCORD Github repo**\nwith direct deploy button\n\n>>>  `repo`",
        "i_q": "repo",
    },
    "gapps": {
