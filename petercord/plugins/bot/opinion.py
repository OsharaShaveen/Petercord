...
if petercord.has_bot:
    ...
    @petercord.bot.on_callback_query(filters.regex(pattern=r"^op_(y|n)_(\d+)$"))
    ...
    @petercord.bot.on_callback_query(filters.regex(pattern=r"^opresult_(\d+)$"))
