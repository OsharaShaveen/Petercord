...
@petercord.on_cmd("vdelto", about={"header": "View auto message delete timeout"})
...
@petercord.on_cmd("vapicto", about={"header": "View auto profile picture timeout"})
...
@petercord.on_cmd("vesto", about={"header": "View edit sleep timeout"})
