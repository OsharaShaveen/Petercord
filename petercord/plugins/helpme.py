...
REPO_X = InlineQueryResultArticle(
    title="Repo",
    input_message_content=InputTextMessageContent("**Here's how to setup 𝗣𝗘𝗧𝗘𝗥𝗖𝗢𝗥𝗗** "),
    ...
    reply_markup=InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    "🎖 𝗣𝗘𝗧𝗘𝗥𝗖𝗢𝗥𝗗", url="https://github.com/IlhamMansiez/Petercord"
                ),
                InlineKeyboardButton(
                    "🎖DEPLOY 𝗣𝗘𝗧𝗘𝗥𝗖𝗢𝗥𝗗",
                    url=(
    ...
    def check_owner(func):
        async def wrapper(_, c_q: CallbackQuery):
            if c_q.from_user and (
                ...
                await c_q.answer(
                    f"Only {user_dict['flname']} Can Access this...! Build Your 𝗣𝗘𝗧𝗘𝗥𝗖𝗢𝗥𝗗",
                    show_alert=True,
                )
    ...
    async def inline_answer(_, inline_query: InlineQuery):
        ...
        if (
                    ...
                    if len(str_y) == 2:
                        ...
                        results.append(
                            InlineQueryResultArticle(
                                ...
                                thumb_url="https://telegra.ph/file/5c8e8741355d7567bb414.jpg",
                                reply_markup=InlineKeyboardMarkup(buttons),
                            )
                        )
                    else:
            ...
            MAIN_MENU = InlineQueryResultArticle(
                title="Main Menu",
                input_message_content=InputTextMessageContent(" 𝗣𝗘𝗧𝗘𝗥𝗖𝗢𝗥𝗗  𝗠𝗔𝗜𝗡 𝗠𝗘𝗡𝗨 "),
                url="https://github.com/IlhamMansiez/Petercord",
