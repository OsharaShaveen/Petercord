...
@petercord.on_cmd("gsetup", about={"header": "Setup GDrive Creds"})
...
@petercord.on_cmd("gclear", about={"header": "Clear GDrive Creds"})
...
@petercord.on_cmd("greset", about={"header": "Reset parent id"})
...
@petercord.on_cmd("gempty", about={"header": "Empty the Trash"})
