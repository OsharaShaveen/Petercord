...
class Message(RawMessage):
    ...
    def __init__(self,
                 client: Union['_client.Userge', '_client.PetercordBot'],
    ...
    @classmethod
    def parse(cls, client: Union['_client.Userge', '_client.PetercordBot'],
    ...
    @property
    def client(self) -> Union['_client.Petercord', '_client.PetercordBot']:
        """ returns client """
        return self._client
