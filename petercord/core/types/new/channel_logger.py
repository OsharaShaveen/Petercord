...
from petercord.utils import SafeDict, get_file_id, parse_buttons, rand_array
...
class ChannelLogger:
    """ Channel logger for Petercord """
    def __init__(self, client: Union['_client.Petercord', '_client.PetercordBot'], name: str) -> None:
    ...
    async def forward_stored(self,
                             client: Union['_client.Petercord', '_client.PetercordBot'],
                             message_id: int,
                             chat_id: int,
                             user_id: int,
        ...
        Parameters:
            client (`Petercord` | `PetercordBot`):
                Pass Petercord or PetercordBot.
